    ...
    <Layout variant="public" showFooterBanner={true}>
      ...
      <section className="pt-16 pb-20 sm:pt-24 sm:pb-28 px-4 sm:px-6 lg:px-8 text-center max-w-5xl mx-auto">
        ...
        <h1 className="text-4xl sm:text-6xl lg:text-7xl font-extrabold text-teal-900 tracking-tight leading-[1.1] mb-6">
          ...
          <span className="block text-coral-500 mt-1">Clearly Explained.</span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <button
            ...
            className="w-full sm:w-auto flex items-center justify-center space-x-2 px-8 py-4 rounded-xl bg-teal-750 text-white font-bold text-base hover:bg-teal-850 transition-all shadow-sm hover:shadow"
          >
          ...
          <button
            ...
            className="w-full sm:w-auto px-8 py-4 rounded-xl bg-white text-slate-800 border border-cream-300 font-bold text-base hover:bg-cream-50 transition-all shadow-xs"
          >
          ...
          <button
            ...
            className="w-full sm:w-auto px-6 py-4 rounded-xl bg-cream-200/70 text-teal-900 font-bold text-base hover:bg-cream-300 transition-all"
          >
            Applicant Workspace
          </button>
        </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
          ...
          <div className="crediwise-card p-8 transition-transform hover:-translate-y-1 duration-200">
            <div className="w-12 h-12 rounded-xl bg-coral-100 text-coral-600 font-bold text-xl flex items-center justify-center mb-6">
              1
            </div>
          ...
          {/* Step 2 */}
          <div className="crediwise-card p-8 transition-transform hover:-translate-y-1 duration-200">
            <div className="w-12 h-12 rounded-xl bg-teal-100 text-teal-850 font-bold text-xl flex items-center justify-center mb-6">
              2
            </div>
            <h3 className="text-xl font-bold text-teal-900 mb-3">
              AI Assessment
        ...
        <div className="crediwise-card p-8 sm:p-12 lg:p-16">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
            ...
            <div className="lg:col-span-7 space-y-6">
              <div>
                <span className="text-xs font-bold tracking-widest text-coral-600 uppercase">
                  EVALUATION FRAMEWORK
                </span>
                <h2 className="text-3xl sm:text-4xl font-extrabold text-teal-900 tracking-tight mt-1">
            ...
            {/* Right Notice Card */}
            <div className="lg:col-span-5 bg-teal-50/70 border border-teal-100 rounded-2xl p-6 sm:p-8 flex flex-col justify-between space-y-6">
              ...
              <div className="pt-4 border-t border-teal-100 flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-xs">
                <span className="text-slate-500 font-medium">Want to see all policy guidelines?</span>
                <Link
                  to="/rules"
                  className="font-bold text-teal-850 hover:text-coral-600 flex items-center space-x-1"
                >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="crediwise-card p-8 sm:p-10 space-y-6">
            <div className="flex items-center space-x-3">
              <div className="w-10 h-10 rounded-xl bg-teal-100 text-teal-850 flex items-center justify-center">
                <FileCheck2 className="w-5 h-5" />
              </div>
              <h3 className="text-2xl font-bold text-teal-900">What You Need</h3>
            </div>
          ...
          <div className="crediwise-card p-8 sm:p-10 space-y-6">
            <div className="flex items-center space-x-3">
              <div className="w-10 h-10 rounded-xl bg-coral-100 text-coral-600 flex items-center justify-center">
                <TrendingUp className="w-5 h-5" />
              </div>
              <h3 className="text-2xl font-bold text-teal-900">What You Receive</h3>
            </div>
            <ul className="space-y-3 text-slate-600 text-sm sm:text-base">
              <li className="flex items-center space-x-2.5">
